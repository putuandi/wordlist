...
def detail(keyword):
    ...
    if type(definitions[0]) is str:
        ...
        existing_words = [word['word'] for word in db.wordlist.find({}, {'_id':False})]
        return render_template('error.html', word=keyword, suggestions=suggestions, existing_words=existing_words)
